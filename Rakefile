...
# rake integration:cloud        # Run Test integration tests in the cloud
# rake integration:docker       # Run Test integration tests using docker
# rake integration:vagrant      # Run Test integration tests using vagrant
